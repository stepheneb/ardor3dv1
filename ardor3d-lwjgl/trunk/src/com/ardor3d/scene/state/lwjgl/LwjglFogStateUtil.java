...
public class LwjglFogStateUtil {
    ...
    public static void apply(final LwjglRenderer renderer, final FogState state) {
        ...
        if (state.isEnabled()) {
            ...
            final ColorRGBA fogColor = state.getColor(ColorRGBA.fetchTempInstance());
            ...
            ColorRGBA.releaseTempInstance(fogColor);
        } else {
    ...
    private static void applyFogColor(final ColorRGBA color, final FogStateRecord record) {
