...
public abstract class RenderState implements Savable {
    ...
    public enum StateType {
        Blend, Fog, Light, Material, Shading, Texture, Wireframe, ZBuffer, Cull, VertexProgram, FragmentProgram, Stencil, GLSLShader, ColorMask, Clip;
     ...
     * <ul>
     * <li>Blend: true</li>
     * <li>Fog: false - because you can change the fog color object directly without telling the state</li>
