...
public class JoglTextureStateUtil {
    ...
    public final static void load(final Texture texture, final int unit) {
        ...
        if (texture.getTextureKey() != null) {
            texture.getTextureKey().setContext(context);
            ...
            if (cached == null && texture.getTextureKey().getContext() == null) {
                texture.getTextureKey().setContext(ContextManager.getCurrentContext());
    ...
    public static void applyTextureTransforms(final Texture texture, final int unit, final TextureStateRecord record,
        ...
        final boolean doTrans = !texture.isIdentityTransform();
        ...
        if (doTrans) {
            ...
            texture.getTransform(record.tmp_matrixBuffer, true);
            record.tmp_matrixBuffer.rewind();
            gl.glLoadMatrixf(record.tmp_matrixBuffer);
